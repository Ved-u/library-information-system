...
public class reservebook extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
       reservebook iu=new reservebook();
    }
	...
	int ii=st.executeUpdate("UPDATE bk SET reservedby='"+userroll+"' where bookid='"+issbook+"'");
	int iii=st.executeUpdate("UPDATE bk SET ReservedFlag=1 where bookid='"+issbook+"'");
